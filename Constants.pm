...
use constant FILE_NAMES => {	accountSettingsScript => 'account_setting.pl',
				...
				expressBackupScript => 'local_backup.pl',
...
use constant CONST => {
		...
		#------------------Menu Choice---------------------#
			...
			Product => 'ForLinux',
			ScriptBuildVersion => '2.33',
			ScriptReleaseDate => '10-17-2022',
		#------------------EVS Operations ---------------------#
		...
		#--------------------- D -----------------------------#
			...
			reallyEditQuery => 'Do you wish to modify (y/n)',#     'Do you really want to edit (y/n)?',
...
#			emailNotConfig	=> 	'Could not configure email address.',
			...
			ExpressBackupProgress => "Local Backup Progress        \n=======================        \n",
		#------------------- F ----------------------------#
			...
			trashFileRestoreNotice => "** If the files for backup are present in trash then it will be restored directly to your account.\n These files will be included in the 'Files already present' count.",
        #------------------- G ----------------------------#
		...
		#------------------- I ----------------------------#
			...
			EvsMissingErr	=> 	'EVS binary is missing. Please reconfigure your account using '.FILE_NAMES->{accountSettingsScript}.' script and try again.',
		...
		#------------------- L ----------------------------#
			...
			logoutExpressBackupJob	=> 'Logging out from your account will terminate Local Backup job. Do you want to continue (y/n)?',
			...
			logoutBackupExpressBackupJob => 'Logging out from your account will terminate Manual Backup and Local Backup. Do you want to continue (y/n)?',
			logoutExpressBackupRestoreJob => 'Logging out from your account will terminate Manual Local Backup and Restore job. Do you want to continue (y/n)?',
			logoutBackupExpressBackupRestoreJob => 'Logging out from your account will terminate Manual Backup, Local Backup and Restore job. Do you want to continue (y/n)?',
...
#			noServicePath	=> 'Service directory does not exists. Please run account_setting.pl script... ',
		...
		#------------------- P ----------------------------#
			...
			EvsProblem      =>      'Problem with EVS binary. Please reconfigure your account using '.FILE_NAMES->{accountSettingsScript}.' script and try again.',
...
#			InvalidPassPattern => q(Password should be at least 6 - 20 characters and can contain A-Z, a-z, 0-9 and ~`!@#$%^&*()-_+={}|[];'"<>,.?/ . Please try again.),
		...
		#------------------- S ----------------------------#
			...
			restoreFromLocationNotFound	=> 'Restore from location not found. Please logout and reconfigure your account freshly using '.FILE_NAMES->{accountSettingsScript}.' and try again.',
			...
			serverRootNotFound => 'Your account not configured for express backup. Please logout and reconfigure your account freshly using '.FILE_NAMES->{accountSettingsScript}.' and try again.',
		#------------------- T ----------------------------#
		...
		#------------------- U ----------------------------#
			...
			noServiceLoc	=> 'unable to find service location, please reconfigure your account.',
